...
# --- 2. HILFSFUNKTIONEN (HYBRID CHECK) ---
...
# --- 4. NEUER HEADER: H1 & LOGO (KEINE RAKETE) ---
# Wir nutzen Columns, um Logo und H1 nebeneinander zu platzieren
header_col1, header_col2 = st.columns([1, 10])

# Platzhalter für das Integral-Logo (Ersetze 'integral_logo.png' durch deinen Pfad)
with header_col1:
    # Falls du kein Logo hast, wird ein Platzhalter angezeigt.
    # Um ein echtes Logo zu nutzen, lade eine Datei hoch und nutze:
    # st.image("integral_logo.png", width=60)
    st.markdown("🌐", help="Hier würde das Integral-Logo platziert.") # Temporärer Platzhalter

with header_col2:
    # H1 Titel ganz oben, ohne Rakete
    st.markdown("<h1>INTEGRAL PRO</h1>", unsafe_allow_html=True)

st.divider()

# --- 5. UI: INPUT MIT HYBRID-LOGIK ---
